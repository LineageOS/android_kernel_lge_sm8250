...
#if defined(TFA_SET_EXT_INTERNALLY) && defined(QPLATFORM)
...
int tfa_afe_dsp_msg(struct tfa_device *tfa,
...
enum tfa98xx_error tfa_afe_dsp_msg_read(struct tfa_device *tfa,
...
#if defined(TFA_SET_EXT_INTERNALLY) && defined(MPLATFORM)
...
int tfa_ipi_dsp_msg(struct tfa_device *tfa,
    int length, const char *buf)
{
...
enum tfa98xx_error tfa_ipi_dsp_msg_read(struct tfa_device *tfa,
	int length, unsigned char *buf)
{
